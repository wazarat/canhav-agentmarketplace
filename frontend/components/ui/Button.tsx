...
/**
 * Lightweight `asChild` implementation: when `asChild` is true and the children
 * is a single React element, we clone it and apply the button classes. This
 * avoids the Radix Slot dep and lets us safely render `<a>` / `<Link>` triggers.
 */
